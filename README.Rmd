...
[![GitHub license](https://img.shields.io/github/license/QianYe-stat/SRS)](https://github.com/QianYe-stat/SRS/blob/master/LICENSE)
...
* Manually add badges through https://shields.io/. Also add lifecycle badge by using `use_lifecycle_badge("Experimental")`
