...
- Suppose $X$ following a uniform distribution within interval $(0,12)$; that is 
...
- Use the `SRS` package to take multiple SRS from the population and study the sampling distribution.
...
```
- By observing the histogram and summary statistics of sample means from SRS, the Central Limit Theorem is confirmed; that is
\[
